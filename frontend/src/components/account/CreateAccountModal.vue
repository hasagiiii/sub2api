<template>
  ...
  >
    ...
    >
      ...
      <div
        v-if="form.platform === 'anthropic' || String(form.platform) === 'antigravity'"
        class="border-t border-gray-200 pt-4 dark:border-dark-600"
      >
        <div class="flex items-center justify-between">
          <div>
      ...
      <div
        v-if="form.platform === 'openai' && String(form.type) === 'oauth'"
        class="border-t border-gray-200 pt-4 dark:border-dark-600"
      >
        <div class="flex items-center justify-between">
          <div>
      ...
      <div
        v-if="form.platform === 'openai' && ['oauth', 'setup-token', 'apikey'].includes(String(form.type))"
        class="border-t border-gray-200 pt-4 dark:border-dark-600"
      >
      ...
      <div v-if="String(form.platform) === 'antigravity'" class="space-y-4 border-t border-gray-200 pt-4 dark:border-dark-600">
