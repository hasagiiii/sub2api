    ...
    <Teleport to="body">
      ...
      >
        ...
        <div class="max-h-80 overflow-y-auto">
          <section v-for="section in groupedQuickOptions" :key="section.kind">
            <div
              class="sticky top-0 z-10 flex h-8 items-center px-3 text-xs font-semibold"
              :class="section.kind === 'org'
                ...
                : section.kind === 'plan'
                  ...
                  : 'bg-gray-50 text-gray-700 dark:bg-dark-700 dark:text-gray-200'"
