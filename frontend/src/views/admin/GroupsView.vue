...
import {
  ...
  moveModelsListItem,
  selectAllModelsListItems as selectAllModelAllowlistItems,
...
const createModelsListState = createModelAllowlistState;
...
const createModelsListLoading = createModelAllowlistLoading;
const editModelsListLoading = editModelAllowlistLoading;
...
const addAllowlistCustomEntry = (
  state: typeof createModelAllowlistState,
  input: { value: string },
  error: { value: string | null },
) => {
  const result = addCustomModelAllowlistItem(state, input.value);
  error.value = result
    ? `admin.groups.modelsList.errors.${result === "invalid_wildcard" ? "invalidWildcard" : result}`
    : null;
...
const moveCreateModelAllowlistItem = moveCreateModelsListItem;
