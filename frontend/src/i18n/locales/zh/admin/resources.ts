export default {
    ...
    usage: {
      ...
      manualImageBilling: '手动完成图片扣费',
      manualImageBillingSuccess: '图片扣费已完成',
      manualImageBillingFailed: '图片扣费失败',
      manualImageBillingHint: '系统未能自动完成结算，预扣金额为 ${held}。请输入本次图片最终应扣费用，系统将按预扣金额多退少补。',
