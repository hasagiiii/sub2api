export default {
    ...
    channels: {
      ...
      form: {
        ...
        modelInputHintWithCandidates: '选择候选模型，或输入完整模型名后按回车添加',
        modelCandidateAdd: '添加',
        billingMode: '计费模式',
        ...
        imageInputPricePerImage: '输入图片单价（美元/张，0 表示免费）',
        ...
        addPixelTier: '添加按像素层级',
        maxPixels: '最大总像素（最后一层可留空）',
