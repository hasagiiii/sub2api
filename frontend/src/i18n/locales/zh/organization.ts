export default {
  organization: {
    ...
    membersActions: { delete: '删除', deleteTitle: '永久删除已归档成员', deleteConfirm: "确定要永久删除成员 '{name}' 吗？账号及授权将被删除且无法恢复，企业资金流水和操作记录会保留。" },
    audit: {
      title: '操作记录',
    ...
    balanceSource: { label: '扣费来源', self: '主账号余额', allocated: '子账号划拨余额', shared: '历史共享余额', company: '企业余额', subscription: '企业订阅套餐', personal_sub: '订阅套餐' },
    subscriptions: { description: '为企业开通订阅套餐（分组），企业 API 密钥可绑定这些套餐使用其额度。', createTitle: '开通订阅套餐', group: '套餐分组', sharedPlan: '共享套餐额度', groupUsage: '分组用量', cancelGroup: '取消 {group}', selectGroup: '请选择分组', createHint: '开通订阅套餐需付费下单，与个人订阅一致，费用由当前所有者支付，订阅将开通到公司主体。', empty: '暂无订阅套餐', rate: '倍率', status: '状态', usage: '用量', expiresAt: '到期时间', daily: '日', weekly: '周', monthly: '月', unlimited: '未限额', unlimitedDesc: '当前套餐没有配置用量限制', cancel: '取消订阅', statuses: { active: '生效中', expired: '已过期', cancelled: '已取消' } },
