export default {
  ...
  keys: {
    ...
    groupLabel: '分组',
    selectGroup: '选择分组',
    groupSelectionHint: '分组选择与列表中的分组菜单保持一致。',
    routeGroupLabel: '路由分组',
    routeGroupHint: '订阅套餐只决定额度来源，路由分组决定请求发送到哪里。',
    normalGroupLabel: '普通分组',
    poolLabel: '订阅套餐',
    poolBadge: '订阅套餐',
    poolSubscription: '订阅额度',
    poolPlanLabel: '所属订阅：{name}',
    poolPlanDescription: '该分组属于“{name}”订阅套餐，会从订阅套餐中扣费。',
    selectPool: '请选择订阅套餐',
    poolHint: '你有多个套餐都包含该分组，请选择本密钥使用哪一份订阅额度。分组仍由上方选择，套餐只决定额度来源。',
    poolRequired: '请选择订阅套餐',
    poolExpiresAt: '到期 {date}',
    poolChangedSuccess: '订阅套餐已更新',
  ...
  admin: {
    ...
    users: {
      ...
      allRoles: '全部角色',
      allStatus: '全部状态',
      enterpriseIdentityFilter: '企业身份',
      allEnterpriseIdentities: '全部身份',
...
decodeSizeOnRspHint: '开启后上游不返回 size 字段或返回 size=auto 时，系统会解码 b64_json 内容识别真实宽高用于计费；URL 模式不受影响。',
    ...
    subscriptions: {
      ...
      selectPlan: '选择订阅套餐',
      planHint: '与用户自行购买一致：发放一条覆盖套餐全部分组的订阅，这些分组共享套餐的一份限额',
    ...
    modelIntros: {
      ...
      schedulingEnabled: '已调度',
      schedulingDisabled: '未调度',
      schedulingUpdated: '演练台调度状态已更新',
      schedulingToggleHint: '切换演练台调度',
      tryIt: '试一试',
      tryItDisabled: '请先开启演练台调度',
      loadFailed: '加载列表失败',
      created: '介绍已创建',
      updated: '介绍已更新',
      saveFailed: '保存失败',
      ...
      fields: {
        ...
        sortOrder: '排序 (小值靠前)',
        schedulingEnabled: '显示在演练台',
        schedulingEnabledHint: '关闭后不会展示在用户演练台，但仍可通过 API 继续调用。',
