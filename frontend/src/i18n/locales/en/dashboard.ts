export default {
  ...
  keys: {
    ...
    preferCompanyBalanceLabel: 'Prefer company balance',
    preferCompanyBalanceHint: 'When disabled, charges outside the subscription are deducted from the personal balance first.',
