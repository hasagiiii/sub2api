export default {
  organization: {
    ...
    balanceSource: { label: 'Balance source', self: 'Root balance', allocated: 'Allocated member balance', shared: 'Legacy shared balance', company: 'Company balance', subscription: 'Enterprise subscription', personal_sub: 'Subscription plan' },
    subscriptions: { description: 'Provision subscription plans (groups) for the company; enterprise API keys can bind to these plans and consume their quota.', createTitle: 'Provision subscription', group: 'Plan group', sharedPlan: 'Shared plan quota', groupUsage: 'Group usage', cancelGroup: 'Cancel {group}', selectGroup: 'Select a group', createHint: 'Provisioning a subscription requires a paid order, just like a personal subscription. The current owner pays and the subscription is provisioned onto the company subject.', empty: 'No subscriptions yet', rate: 'Rate', status: 'Status', usage: 'Usage', expiresAt: 'Expires', daily: 'Daily', weekly: 'Weekly', monthly: 'Monthly', unlimited: 'Unlimited', unlimitedDesc: 'No usage limits are configured for this subscription', cancel: 'Cancel', statuses: { active: 'Active', expired: 'Expired', cancelled: 'Cancelled' } },
