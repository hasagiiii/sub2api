export default {
    ...
    usage: {
      ...
      manualImageBilling: 'Complete image billing manually',
      manualImageBillingSuccess: 'Image billing completed',
      manualImageBillingFailed: 'Failed to complete image billing',
      manualImageBillingHint: 'Automatic settlement failed. The held amount is ${held}. Enter the final image charge to refund or collect the difference.',
