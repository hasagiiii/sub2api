export default {
    ...
    channels: {
      ...
      form: {
        ...
        modelInputHintWithCandidates: 'Select a suggested model or enter a full model name, then press Enter.',
        modelCandidateAdd: 'Add',
        billingMode: 'Billing Mode',
        ...
        imageInputPricePerImage: 'Input image price / image (0 = free)',
        ...
        addPixelTier: 'Add pixel tier',
        maxPixels: 'Max pixels (last tier may be unlimited)',
    ...
    subscriptions: {
      ...
      unlimited: 'Unlimited',
      unlimitedDesc: 'No usage limits are configured for this subscription',
