export default {
  ...
  keys: {
    ...
    groupSelectionHint: 'Group choices follow the same binding menu used in the key list.',
    routeGroupLabel: 'Routing group',
    routeGroupHint: 'The subscription plan selects the quota source; the routing group selects where requests go.',
    ...
    poolPlanDescription: 'This group belongs to {name} subscription plan and is charged against the subscription plan.',
    ...
    poolExpiresAt: 'Expires {date}',
    poolChangedSuccess: 'Subscription plan updated',
    fallbackGroupsLabel: 'Fallback groups',
    fallbackGroupsHint: 'Tried in order when the primary is unavailable. Groups must use the same platform; subscription and metered billing may be mixed.',
    selectFallbackGroup: 'Add a same-platform fallback',
    fallbackGroupsSelectPrimary: 'Select a primary group before configuring same-platform fallbacks.',
    fallbackGroupsEmpty: 'No other available groups use the same platform.',
    fallbackGroupsLimit: 'You can configure up to 5 fallback groups.',
  ...
  usage: {
    ...
    videoDimNotRecorded: 'Not recorded',
  ...
  admin: {
    ...
    users: {
      ...
      allRoles: 'All Roles',
      allStatus: 'All Status',
      enterpriseIdentityFilter: 'Enterprise Identity',
      allEnterpriseIdentities: 'All Identities',
      ...
      copyIAMPrincipal: 'Copy IAM login principal',
      iamPrincipalCopied: 'IAM login principal copied',
      enterpriseIdentity: {
        owner: 'Owner account',
        member: 'IAM account',
        unknown: 'Enterprise account'
      },
      notes: 'Notes',
    ...
    groups: {
      ...
      imagePricing: {
        ...
        matrixTitle: 'Tier × Quality pricing matrix',
        matrixHint: 'The first tier whose short-edge threshold covers the request is used. Empty cells fall back to the legacy prices below.',
        matrixTierHeader: 'Tier',
        matrixResolutionHeader: 'Resolution threshold',
...
decodeSizeOnRspHint: 'When the upstream response omits the size field or returns size=auto, decode the b64_json content to recover the real width and height for billing. URL-only responses are not affected.',
    ...
    channels: {
      ...
      form: {
        ...
        resolutionThreshold: 'Resolution threshold',
        imageTierValidation: 'Image tiers must use 1K, 2K, or 4K with WIDTHxHEIGHT resolutions; qualities in one tier must share a threshold and tier thresholds must increase',
        ...
        responsesDefaultImageQuality: 'Default Responses Image Quality',
        responsesDefaultImageQualityHint: 'Used for usage records and image pricing when neither the /responses request nor response provides a quality. Defaults to medium.',
    ...
    files: {
      title: 'File Manager',
      subtitle: 'Browse, upload, download, rename and delete files in your image-transfer object storage.',
      disabledTitle: 'Image transfer is not enabled',
      disabledHint: 'The file manager requires image transfer (COS / S3-compatible) to be enabled. Go to Settings → Image Transfer, fill in the bucket and credentials, then tick "Enable image transfer".',
      gotoSettings: 'Go to Settings',
      bucket: 'Bucket',
      configuredPrefix: 'Configured prefix',
      root: 'Root',
      searchPlaceholder: 'Search by name prefix…',
      searchHint: 'Object storage only supports prefix matching; search looks into subdirectories',
      colName: 'Name',
      colSize: 'Size',
      colModified: 'Modified',
      colActions: 'Actions',
      empty: 'No files in this directory',
      loadedCount: '{n} item(s) loaded',
      loadMore: 'Load more',
      noMore: 'All items loaded',
      upload: 'Upload',
      importUrl: 'Import from URL',
      importUrlLabel: 'File URL',
      importNameLabel: 'File name (optional)',
      importNamePlaceholder: 'Detected from the URL by default',
      importConfirm: 'Import',
      importCurrentDirectory: 'Imports into the current directory: {path}',
      importSuccess: 'Imported file: {name}',
      download: 'Download',
      rename: 'Rename',
      copyUrl: 'Copy URL',
      ...
      dropToUpload: 'Drop to upload to the current directory',
      uploadingProgress: 'Uploading {i}/{n}: {name}',
      uploadSuccess: 'Uploaded {n} file(s)',
      uploadFailed: '{n} upload(s) failed: {msg}',
      overwriteConfirm: 'A file named "{name}" already exists in this directory. Overwrite it?',
      overwriteSkipped: '{n} conflicting file(s) skipped because overwrite was cancelled',
      unknownFileName: 'this file',
      renameTitle: 'Rename file',
      currentKey: 'Current object key',
      newName: 'New name',
      renameHint: 'Only the file name changes; the directory stays the same. Object storage has no rename operation — this performs a server-side copy to the new name followed by deleting the original.',
      renameSuccess: 'Renamed successfully',
      deleteTitle: 'Delete files',
      deleteOneConfirm: 'Delete "{name}"? This cannot be undone, and any record referencing this file will break.',
      deleteManyConfirm: 'Delete the {n} selected file(s)? This cannot be undone, and any record referencing them will break.',
      deleteSuccess: 'Deleted {n} file(s)',
      deleteFailed: '{n} deletion(s) failed: {msg}',
      // Backend reasons → friendly messages (keys must match the backend `reason`)
      errors: {
        COS_NOT_CONFIGURED: 'Image transfer is not enabled or not fully configured. Please finish the setup under Settings → Image Transfer.',
        INVALID_OBJECT_KEY: 'Invalid object key (must be non-empty, must not contain ".." or control characters, and must be at most 1024 bytes).',
        OBJECT_KEY_EXISTS: 'An object with that name already exists. Pick another name — rename never overwrites existing data.',
        LIST_NOT_SUPPORTED: 'The current object storage implementation does not support listing.',
        COPY_NOT_SUPPORTED: 'The current object storage implementation does not support server-side copy, so renaming is unavailable.',
        INVALID_URL: 'Enter a valid public URL starting with http:// or https://.',
        URL_BLOCKED: 'That URL points to an internal, local, or otherwise restricted address.',
        URL_FETCH_FAILED: 'Could not download that URL. Make sure it is publicly accessible and has not expired.',
        EMPTY_REMOTE_FILE: 'That URL returned an empty file and could not be imported.',
      },
    },

    // Model Intros (cover / description / default params)
    modelIntros: {
      title: 'Model Intros',
      description: 'Configure title, description, default params and cover image for each public model',
      createBtn: 'New Intro',
      listImport: 'Import list',
      listExport: 'Export list',
      listImportConfirm: 'Import {count} model intros? Existing records with the same model_key will be overwritten.',
      listImported: 'Imported {count} model intros',
      listImportFailed: 'Import failed. Check the JSON file format and contents.',
      listExported: 'Exported {count} model intros',
      listExportFailed: 'Failed to export model intros',
      createTitle: 'New Model Intro',
      editTitle: 'Edit Model Intro',
      detailTitle: 'Model Detail',
      deleteTitle: 'Delete Model Intro',
      deleteConfirm: 'Delete this model intro? This action cannot be undone.',
      searchPlaceholder: 'Search by model_key / title',
      schedulingEnabled: 'Scheduled',
      schedulingDisabled: 'Not scheduled',
      schedulingUpdated: 'Playground scheduling updated',
      schedulingToggleHint: 'Toggle playground scheduling',
      tryIt: 'Try it',
      tryItDisabled: 'Enable playground scheduling first',
      loadFailed: 'Failed to load list',
      created: 'Model intro created',
      updated: 'Model intro updated',
      saveFailed: 'Save failed',
      deleted: 'Model intro deleted',
      deleteFailed: 'Delete failed',
      detail: {
        curlTitle: 'curl Example',
        curlHint: 'Assumes the gateway is deployed at the current origin. Replace YOUR_API_KEY with a real API key, and adjust the JSON body as needed.'
      },
      columns: {
        cover: 'Cover',
        modelKey: 'Model / Title',
      ...
      fields: {
        modelKey: 'Model Key',
        modelKeyPlaceholder: 'e.g. gpt-4o or bytedance/seedance-2.5/text-to-video',
        modelKeyHint: 'Must match the public model name. Cannot be changed after creation; delete and recreate to rename.',
        modelKeyUseCustom: 'Use custom',
        modelKeySearchPlaceholder: 'Search or type a custom model name…',
        modelKeyEmpty: 'No matching upstream model. Type any value to use it as-is.',
        candidatesHint: '{n} upstream candidates available in dropdown',
        candidatesLoading: 'Loading upstream candidates…',
        title: 'Display Title',
        titlePlaceholder: 'Leave empty to fall back to model_key',
        description: 'Model Introduction',
        descriptionPlaceholder: 'Describe capabilities, typical use cases, etc. (Markdown / HTML are not rendered)',
        descriptionPlaceholderEn: 'Describe capabilities, typical use cases, etc. (plain text)',
        descriptionLangZh: 'Chinese',
        descriptionLangEn: 'English',
        coverUrl: 'Cover Image URL',
        coverUrlPlaceholder: 'https://... or a relative static asset path',
        sortOrder: 'Sort Order (smaller first)',
        schedulingEnabled: 'Show in playground',
        schedulingEnabledHint: 'When disabled, this model is hidden from the user playground but can still be called through the API.',
        defaultParams: 'Default Params (each field may declare metadata)',
        defaultParamsHint: 'Each row is a parameter: declare its default value, whether required, an optional description, and whether it is an enum (with a list of candidate values). Declared fields will be auto-rendered as inputs in the playground form. When type is json, value will be parsed as JSON; falls back to string on parse errors.',
        defaultParamsEmpty: 'No params yet. Leave empty if this model has no defaults.',
        addParam: 'Add Param',
        paramKey: 'Key',
        paramValue: 'Value',
        paramRequired: 'Required',
        paramAdvanced: 'Advanced (collapsed by default in the playground "Advanced" section)',
        paramDescription: 'Field description (shown as helper text under the input)',
        paramDescriptionEn: 'Field description in English (optional)',
        paramEnum: 'Enum field (restrict to a fixed set of values)',
        paramEnumPlaceholder: 'One per line, or split by comma / semicolon / 中文逗号. Example:\nauto, 21:9, 16:9, 4:3, 1:1, 3:4, 9:16',
        paramEnumHint: 'Separators: newline, English comma, Chinese comma, Chinese enumeration mark, semicolon, and pipe are all accepted (colon is intentionally NOT a separator so values like “21:9” stay intact). Options are coerced by the current field type (number → Number, json → JSON.parse) and rendered as a <select>.',
        outputFields: 'Output Fields',
        schema: 'Schema',
        schemaHint: 'Declare this model’s input / output fields and how the main result is displayed; the playground uses this to auto-render the form and results.',
        inputParams: 'Input Params',
        inputParamsIntro: 'Declare the request body fields accepted by this model. The playground auto-renders a form from this: required fields are validated, description is shown as a hint next to each field, enum fields become a <select>, and default values are pre-filled and used in the curl example.',
        outputParams: 'Output Params',
        outputParamsIntro: 'Declare the response schema returned by this model after a task completes. Follows the exact same shape as Input Params: type can be string / number / boolean / object / array, where object expands child fields and array expands an element schema, with unlimited nesting; every level supports description / required / enum. The playground renders the response accordingly. The primary video / image result is chosen by the "Result Field" and "Result Type" below.',
        outputFieldsHint: 'Declare the response schema returned by this model. Top-level keys support property paths / array indexing / wildcards (e.g. video.url, images[0].url, images[*]); composite types (object / array) can keep nesting child fields. The primary result field is no longer picked per-row — select it below under "Result field".',
        addOutputField: 'Add Output Field',
        outputFieldsEmpty: 'No output fields configured; the playground will only show the raw payload after completion.',
        outputKeyPlaceholder: 'Path, e.g. video.url / images[0].url / seed',
        outputLabelPlaceholder: 'Display name (optional), e.g. Generated video',
        outputDescriptionPlaceholder: 'Field description (optional), shown next to the field in the playground',
        outputDefaultPlaceholder: 'Default value (optional, for documentation only)',
        resultField: 'Result field',
        resultFieldNone: '(not selected — fall back to the first video/image)',
        resultFieldHint: 'Pick one output field as the main result; the playground will display it in a large media viewer.',
        resultFieldBadge: 'primary',
        resultType: 'Result type',
        resultTypeVideo: 'Video',
        resultTypeImage: 'Image',
        resultTypeHint: 'Controls whether the primary result is rendered with <video> or <img>.',
        schemaCopy: 'Copy JSON',
        schemaDownload: 'Download JSON',
        schemaImport: 'Import / From URL',
        schemaCopied: 'Schema copied to clipboard',
        schemaCopyFailed: 'Copy failed. Please select the JSON and copy manually.',
        schemaExportedFile: 'Schema file download started',
        schemaImportTitle: 'Import Schema / Generate from doc URL',
        schemaImportHint: 'Paste JSON below or pick a local .json file. Clicking “Apply Import” overwrites only the keys present in the JSON (input params / output params / result field / result type, plus title and the Chinese/English intros). Missing keys are left untouched.',
        schemaImportPickFile: 'Choose file…',
        schemaImportPlaceholder: 'Paste your schema JSON here…',
        schemaImportApply: 'Apply Import',
        schemaImportEmpty: 'Import content is empty',
        schemaImportShape: 'Invalid JSON shape. The top level must be an object; recognized keys are default_params, output_fields, result_field and result_type.',
        schemaImportParseFailed: 'JSON parse failed: {msg}',
        schemaImportReadFailed: 'Failed to read file',
        schemaImportedSuccess: 'Schema imported into the current form. Review and save.',
        // ---- Generate from a documentation URL (fetch page + LLM extraction) ----
        docSection: 'Generate from a doc URL (recommended)',
        docSectionHint: 'Paste the model documentation page URL. The server fetches the page and an LLM turns it into the JSON below (title, Chinese/English intro, input params, output params, result field). Review the result, then click “Apply Import” to fill the form. Select an API Key and model at the bottom of the edit dialog first.',
        docUrlPlaceholder: 'Model doc page URL, e.g. https://fal.ai/models/fal-ai/xxx',
        docHintPlaceholder: 'Extra instructions (optional), e.g. only text-to-video params, duration is in seconds',
        docGenerate: 'Fetch & generate',
        docGenerating: 'Generating…',
        docFetching: 'Fetching the page…',
        docParsing: 'Fetched {chars} characters, asking the model to parse…',
        docGenerated: 'Generated. Review the JSON below, then click “Apply Import”.',
        docGeneratedTruncated: 'Generated (page content was truncated — double-check that all params are present).',
        docFailed: 'Generation failed: {msg}',
        docUrlRequired: 'Please enter the documentation page URL first',
        // Short column labels shown above each control in the row editor
        labelKey: 'Key',
        labelType: 'Type',
        labelDefault: 'Default',
        labelDisplayName: 'Display name',
        labelDescription: 'Description',
        labelDescriptionZh: 'Chinese',
        labelDescriptionEn: 'English',
        // ---- Description translation button (per label) + footer translation tools ----
        translateBtn: 'Translate',
        translateBtnTitle: 'Translate from the other language via an LLM',
        translateNotReady: 'Select an API Key and target model at the bottom first',
        translateSourceEmpty: 'The other-language field is empty; nothing to translate',
        ...
        translationSelectKey: 'Select API Key',
        translationNoKey: 'No available API Key',
        translationModelPlaceholder: 'Select a model',
        translationModelHint: 'Chat model used for translation; your selected API Key must have access',
        ...
        mediaUrlsItemsFixed:
          'The {widget} control is selected. Each element is a full URL for that media type, so there is no element schema to configure. The playground provides upload, library, URL import, and drag-to-reorder actions.',
        // Row reordering (drag handle + up/down arrows)
        dragToReorder: 'Drag to reorder',
        moveUp: 'Move up',
        moveDown: 'Move down',
        jsonTreeHint: '(tree editor: add object keys / array items, switch leaf types)'
      },
      errors: {
        modelKeyRequired: 'model_key is required',
        paramJsonInvalid: 'Default value of field “{key}” is not valid JSON; cannot save'
      }
    },
    ...
    settings: {
      ...
      features: {
        video: {
          title: 'Video',
          description: 'Controls user video models, the materials library, and the video generation gateway. Disabled by default.',
          enabled: 'Enable video features',
          enabledHint: 'When off, Video Models and Materials are hidden and /api/v1/model requests are rejected.',
        },
        channelMonitor: {
          title: 'Channel Monitor',
  ...
  payment: {
    ...
    admin: {
      ...
      selectGroup: 'Select a group',
      groupRequired: 'Please select at least one subscription group',
      groups: 'Subscription groups',
      groupsHint: 'Multiple allowed. The selected groups share one plan quota (not one each); the first selection is the primary group used for display.',
      planLimits: 'Plan limits (USD)',
      planLimitsHint: 'Shared across the selected groups. Setting any window switches the whole subscription to plan limits; other unset windows are unlimited and do not fall back to group limits.',
