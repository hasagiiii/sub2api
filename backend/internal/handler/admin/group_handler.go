...
type CreateGroupRequest struct {
	...
	Description               string                        `json:"description"`
	Platform                  string                        `json:"platform" binding:"omitempty,oneof=anthropic openai gemini antigravity kiro grok fal leonardo atlascloud apiz higgsfield kimi zhipu deepseek minimax bytedance opencode_go composite"`
