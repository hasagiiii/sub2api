...
type CreateGroupRequest struct {
	...
	Platform                  string                        `json:"platform" binding:"omitempty,oneof=anthropic openai gemini antigravity kiro grok fal leonardo kimi zhipu deepseek bytedance composite"`
