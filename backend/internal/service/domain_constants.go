...
const (
	...
	// SettingKeyOpenCodeGoUsageSettings stores the opt-in OpenCode Go usage refresh settings.
	...
	// SettingKeyOpenAICodexTicketEnabled controls the Codex 292 ticket harvester.
	SettingKeyOpenAICodexTicketEnabled = "openai_codex_ticket_enabled"
	// SettingKeyOpenAICodexTicketHarvestProxyURL controls the dedicated harvest proxy.
