...
func init() {
	...
	groupDescKiroAutoStickyEnabled := groupFields[64].Descriptor()
	...
	groupDescKiroStickySessionTTLSeconds := groupFields[65].Descriptor()
	...
	groupDescKiroCacheEmulationRatio := groupFields[66].Descriptor()
