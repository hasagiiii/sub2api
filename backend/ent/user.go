...
type UserEdges struct {
	...
	// DeveloperKeys holds the value of the developer_keys edge.
	DeveloperKeys []*DeveloperKey `json:"developer_keys,omitempty"`
...
// DeveloperKeysOrErr returns the DeveloperKeys value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) DeveloperKeysOrErr() ([]*DeveloperKey, error) {
	if e.loadedTypes[1] {
		return e.DeveloperKeys, nil
	}
	return nil, &NotLoadedError{edge: "developer_keys"}
}
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldMustChangePassword, user.FieldTotpEnabled, user.FieldRestrictPublicGroups, user.FieldBalanceNotifyEnabled:
...
// QueryDeveloperKeys queries the "developer_keys" edge of the User entity.
func (_m *User) QueryDeveloperKeys() *DeveloperKeyQuery {
	return NewUserClient(_m.config).QueryDeveloperKeys(_m)
}
