...
func (_u *UserUpdate) AddSSOSessionIDs(ids ...int64) *UserUpdate {
...
func (_u *UserUpdate) RemoveSSOSessionIDs(ids ...int64) *UserUpdate {
...
// AddSSOSessionIDs adds the "sso_sessions" edge to the SsoSession entity by IDs.
func (_u *UserUpdateOne) AddSSOSessionIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.AddSSOSessionIDs(ids...)
	return _u
}
...
// RemoveSSOSessionIDs removes the "sso_sessions" edge to SsoSession entities by IDs.
func (_u *UserUpdateOne) RemoveSSOSessionIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.RemoveSSOSessionIDs(ids...)
	return _u
}
