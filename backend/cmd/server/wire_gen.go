...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	billingContextResolver := service.NewBillingContextResolver(organizationRepository)
	billingCacheService := service.ProvideBillingCacheService(billingCache, userRepository, userSubscriptionRepository, apiKeyRepository, userRPMCache, userGroupRateRepository, configConfig, serviceUserPlatformQuotaRepository, billingContextResolver)
	apiKeyCache := repository.NewAPIKeyCache(redisClient)
	concurrencyCache := repository.ProvideConcurrencyCache(redisClient, configConfig)
	schedulerCache := repository.ProvideSchedulerCache(redisClient, configConfig)
	accountRepository := repository.NewAccountRepository(client, db, schedulerCache)
	concurrencyService := service.ProvideConcurrencyService(concurrencyCache, accountRepository, configConfig)
	apiKeyService := service.ProvideAPIKeyService(apiKeyRepository, userRepository, groupRepository, userSubscriptionRepository, userGroupRateRepository, apiKeyCache, configConfig, billingCacheService, concurrencyService, organizationRepository)
	...
	affiliateService := service.ProvideAffiliateService(affiliateRepository, settingService, apiKeyAuthCacheInvalidator, billingCacheService, publisher, userRepository)
	...
	subscriptionGroupLister := service.ProvideSubscriptionGroupLister(groupRepository)
	organizationService := service.ProvideOrganizationService(organizationRepository, userRepository, configConfig, apiKeyAuthCacheInvalidator, settingService, subscriptionGroupLister)
	...
	developerKeyRepository := repository.NewDeveloperKeyRepository(client)
	developerKeyService := service.NewDeveloperKeyService(developerKeyRepository, userRepository)
	developerKeyHandler := handler.NewDeveloperKeyHandler(developerKeyService)
	...
	developerFileService := service.NewDeveloperFileService(cosImageTransferService, userMaterialService)
	...
	responsesImageStatusStore := repository.NewResponsesImageStatusStore(redisClient)
	...
	runtimeLogBroadcaster := repository.NewOpsRuntimeLogBroadcaster(redisClient)
	...
	costCenterRepository := repository.NewCostCenterRepository(db)
	costCenterService := service.NewCostCenterService(costCenterRepository)
	adminService := service.ProvideAdminService(configConfig, userRepository, adminGroupRepository, adminAccountRepository, proxyRepository, apiKeyRepository, redeemCodeRepository, userGroupRateRepository, userRPMCache, billingCacheService, proxyExitInfoProber, proxyLatencyCache, apiKeyAuthCacheInvalidator, client, settingService, subscriptionService, userSubscriptionRepository, privacyClientFactory, openAIGatewayService, affiliateService, compositeModelRouteRepository, compositeRouteResolver, costCenterService, channelService)
	...
	accountHandler := admin.ProvideAccountHandler(configConfig, adminService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, kiroOAuthService, grokOAuthService, rateLimitService, accountUsageService, accountTestService, concurrencyService, crsSyncService, sessionLimitCache, rpmCache, compositeTokenCacheInvalidator, grokQuotaService, costCenterService)
	...
	captchaVerifier := repository.NewCaptchaVerifier()
	captchaService := service.NewCaptchaService(settingService, captchaVerifier)
	...
	settingHandler := handler.ProvideAdminSettingHandler(settingService, emailService, captchaService, aliyunCaptchaService, opsService, paymentConfigService, paymentService, userAttributeService, notificationEmailService, totpService, userService)
	...
	supportTicketNotificationService := service.ProvideSupportTicketNotificationService(supportTicketNotificationRepository, settingService, userService, notificationEmailService, publisher)
	...
	supportTicketNotificationHandler := admin.NewSupportTicketNotificationHandler(supportTicketService, supportTicketNotificationService)
	...
	supportChatLogRepository := repository.NewSupportChatLogRepository(client)
	supportChatLogService := service.NewSupportChatLogService(supportChatLogRepository)
	supportChatLogHandler := admin.NewSupportChatLogHandler(supportChatLogService)
	...
	oidcSigningKeyHandler := admin.NewOidcSigningKeyHandler(oidcSigningService)
	...
	asyncMediaTaskStatusStore := repository.NewAsyncMediaTaskStatusStore(redisClient)
	asyncMediaService := service.ProvideAsyncMediaService(asyncMediaTaskRepository, userRepository, groupRepository, billingService, modelPricingResolver, cosImageTransferService, asyncMediaTaskStatusStore, deferredService, billingContextResolver, billingCacheService, opsService, modelIntroService, configConfig)
	...
	asyncMediaTaskLockStore := repository.NewAsyncMediaTaskLockStore(redisClient)
	asyncVideoService := service.ProvideAsyncVideoService(asyncVideoTaskRepository, userRepository, billingService, deferredService, billingContextResolver, billingCacheService, modelPricingResolver, groupRepository, costCenterService, cosImageTransferService, opsService, asyncMediaTaskLockStore, configConfig)
	...
	handlerSupportTicketNotificationHandler := handler.NewSupportTicketNotificationHandler(supportTicketService, supportTicketNotificationService)
	...
	batchImagePublicService := service.ProvideBatchImagePublicService(batchImageRepository, accountRepository, groupRepository, userGroupRateRepository, batchImageQueue, batchImageModelPricingResolver, usageBillingRepository, apiKeyAuthCacheInvalidator, billingCacheService, configConfig, billingContextResolver)
	...
	notificationOutboxRepository := repository.NewNotificationOutboxRepository(db)
	...
	developerKeyAuthMiddleware := middleware.NewDeveloperKeyAuthMiddleware(developerKeyService)
